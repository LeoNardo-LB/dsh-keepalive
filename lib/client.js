...
function providerBadge(registered, entry, row) {
  if (!registered) {
    return /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { style: { ...styles2.badge, background: "rgba(92,99,112,0.3)", color: "#888" }, children: "\u672A\u6CE8\u518C" });
  }
  if (entry === void 0) {
    return /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { style: { ...styles2.badge, background: "rgba(92,99,112,0.2)", color: "#999", border: "1px dashed #666" }, children: "\u672A\u53C2\u4E0E" });
  }
  if (row?.parked === true) {
...
function ProviderCard(props) {
  ...
  const [modelText, setModelText] = (0, import_react2.useState)(String(configuredModel));
  (0, import_react2.useEffect)(() => {
    setModelText(String(configuredModel));
  }, [configuredModel]);
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { style: styles2.card, children: [
    /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { style: styles2.row, children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { style: { opacity: 0.55, fontSize: "11px" }, children: id }),
      providerBadge(registered, entry, row),
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { style: { opacity: 0.7 }, children: row?.model ?? (entry?.model ?? "\u9ED8\u8BA4\u6A21\u578B") }),
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { style: { marginLeft: "auto", fontVariantNumeric: "tabular-nums" }, children: entry !== void 0 && entry.enabled === true && row !== void 0 ? formatCountdown(countdownMs(row.nextFireAt, state, now)) : "\u2014" })
    ] }),
    entry !== void 0 && row !== void 0 && /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { style: { ...styles2.row, opacity: 0.85 }, children: [
      row.lastResult === null ? "\u5C1A\u65E0\u53D1\u9001\u8BB0\u5F55" : "\u6700\u8FD1: " + (row.lastResult.status === "ok" ? "\u2713 " : "\u2717 ") + String(row.lastResult.latencyMs) + "ms",
      (row.consecutiveFailures ?? 0) > 0 && /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("span", { children: [
        "\u8FDE\u7EED\u5931\u8D25 ",
        String(row.consecutiveFailures)
      ] })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { style: styles2.row, children: entry === void 0 ? /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { style: { marginLeft: "auto" }, children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
      "button",
      {
        style: { ...styles2.button, color: "#98c379", borderColor: "#98c379" },
        disabled: !registered,
      ...
      /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("label", { children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
          "input",
          {
            style: { ...styles2.input, width: "150px" },
            placeholder: "\u9ED8\u8BA4\u6A21\u578B",
            value: modelText,
      ...
      /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("span", { style: { marginLeft: "auto", display: "flex", gap: "6px" }, children: [
        row !== void 0 && entry.enabled === true && /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("button", { style: styles2.button, onClick: () => void store.act("fire-now", id), children: "\u7ACB\u5373\u53D1\u9001" }),
        row?.parked === true && /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("button", { style: styles2.button, onClick: () => void store.act("resume-provider", id), children: "\u6062\u590D" }),
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
          "button",
          {
            style: styles2.button,
        ...
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
          "button",
          {
            style: { ...styles2.button, color: "#e06c75", borderColor: "#e06c75" },
    ...
    status === null ? /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { style: styles2.row, children: "\u52A0\u8F7D\u4E2D\u2026" }) : /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(import_jsx_runtime2.Fragment, { children: [
      ...
      tab === "providers" && /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "ka-section", children: [
        ...
        (() => {
          ...
          return all.map((provider) => /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
            ProviderCard,
            {
              id: provider.id,
              name: provider.name,
